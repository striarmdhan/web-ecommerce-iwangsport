...
<div>
    ...
    <div class="mb-8">
        ...
        <p class="text-sm text-gray-500 mt-1.5">Bergabung dengan Iwangsport dan nikmati koleksi terbaik kami</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <p class="text-xs text-gray-400 leading-relaxed">
            ...
            <a href="#" class="text-[#013D29] underline underline-offset-2">Syarat & Ketentuan</a> dan 
            <a href="#" class="text-[#013D29] underline underline-offset-2">Kebijakan Privasi</a> kami.
        </p>
    ...
    <div class="text-center">
        <p class="text-sm text-gray-500">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="font-semibold text-[#013D29] hover:text-[#025c3e] transition-colors ml-1">Login di sini</a>
        </p>
    </div>
</div>
